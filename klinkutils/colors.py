...
class colors(metaclass=__ColorsMeta__):
    ...
    Options:
        colors.print_help -> prints a display of available formatings
        colors.turn_on -> globally turns on the formatting
        colors.turn_off -> globally turns off the formatting
    """
